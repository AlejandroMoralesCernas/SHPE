...
const Card = (props) => {
    return (
        <div name="Officer Container" className='flex flex-col bg-[#D3D3D3] rounded-2xl md:h-[40rem] md:w-[20rem] w-[90vw] h-[70vh] items-center justify-start shadow-md text-center'>
