...
const Calendar = () => {
  ...
  return (
    <div name='Calendar Container' className='flex flex-col justify-center items-center py-[5rem]'>
      ...
      <iframe name='Calendar' src="https://calendar.google.com/calendar/embed?src=en.usa%23holiday%40group.v.calendar.google.com&ctz=America%2FLos_Angeles" className='h-[80vh] w-[80vw]'></iframe>
    </div>
  )
}
